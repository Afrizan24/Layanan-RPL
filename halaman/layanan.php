    ...
    <div class=" col-md-6 col-lg-4 mb-4">
      <div class="card h-100 d-flex flex-column">
        <div class="card-body d-flex flex-column">
          ...
          <div class="mt-auto"><a href="/rpl/kategori/1<?php echo "?user=". urlencode($_SESSION['username']); ?>">
    ...
    <div class="col-md-6 col-lg-4 mb-4">
      <div class="card h-100 d-flex flex-column">
        <div class="card-body d-flex flex-column">
          ...
          <div class="mt-auto"><a href="/rpl/kategori/2<?php echo "?user=". urlencode($_SESSION['username']); ?>">
            <button type="submit" class="animated-button w-100">Laporkan</button>
          </a>
          </div>
        </div>
    ...
    <div class="col-md-6 col-lg-4 mb-4">
      <div class="card h-100 d-flex flex-column">
        <div class="card-body d-flex flex-column">
          ...
          <div class="mt-auto"><a href="/rpl/kategori/3<?php echo "?user=". urlencode($_SESSION['username']); ?>">
            <button type="submit" class="animated-button w-100">Laporkan</button>
          </a>
          </div>
        </div>
